            ...
            <header>
                ...
                ${
                    this.userState == 'loading'
                        ...
                        : this.userState == 'loaded'
                            ? this.user
                                ? x`<a href="#" @click=${ history.pushState({}, "", "/me") }>${this.user.displayName}</a>`
...
class MiTango extends s {
    ...
    render() {
        if (this.page == 'home') return x`<home-page></home-page>`
        else return x`<not-found-page></not-found-page>`
    }
}
