...
const showPageByHash = () => {
    if (location.hash === '') {
        ...
        j$1(h(x`<div><img src=https://picsum.photos/100/100></div><div><a class="font-bold" href=#>milonga</a></div>`), root);
    } else if (location.hash === '#dj') {
        j$1(h(x`<div><img src=https://picsum.photos/100/100></div><div><a class="font-bold" href=#>dj</a></div>`), root);
    } else if (location.hash === '#milonga_event') {
        j$1(h(x`<div><img src=https://picsum.photos/100/100></div><div><a class="font-bold" href=#>milonga_event</a></div>`), root);
    } else if (location.hash === '#club') {
        j$1(h(x`<div><img src=https://picsum.photos/100/100></div><div><a class="font-bold" href=#>club</a></div>`), root);
    } else {
        j$1(h(x`<div>404</div>`), root);
    }
};
